...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width': '80%', 'textAlign': 'center','font-size': '20px'}
        )
    ]),
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(yearly_data, x='Month', y='Automobile_Sales', title='Total Montly Automobile Sales'))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart_item', children=[html.Div(Y_chart1),html.Div(Y_chart2)]),
                html.Div(className='chart_item', children=[html.Div(Y_chart3),html.Div(Y_chart4)])
                ]
